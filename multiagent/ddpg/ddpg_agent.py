...
from multiagent.ddpg.actor import ActorNetwork
from multiagent.ddpg.critic import CriticNetwork
...
class Agent(object):
    ...
    def save_count(self):
        ...
        T.save(self.count, os.path.join('tmp', 'count'))

    def load_count(self):
        print('... loading counter ...')
        self.count = T.load(os.path.join('tmp', 'count'))
